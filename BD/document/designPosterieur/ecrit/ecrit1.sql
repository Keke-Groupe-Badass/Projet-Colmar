...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 08 déc. 2022 à 15:40
...
CREATE TABLE IF NOT EXISTS `ecrit` (
  ...
  KEY `ecrit_ouvrages0_FK` (`idOuvrage`)
...
--
ALTER TABLE `ecrit`
  ADD CONSTRAINT `ecrit_auteurs_FK` FOREIGN KEY (`idAuteur`) REFERENCES `auteurs` (`idAuteur`),
  ADD CONSTRAINT `ecrit_ouvrages0_FK` FOREIGN KEY (`idOuvrage`) REFERENCES `ouvrages` (`idOuvrage`);
COMMIT;
